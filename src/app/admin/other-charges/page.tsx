  ...
  return (
    <div style={{ maxWidth: "600px" }}>
      <div style={{ marginBottom: "2rem" }}>
        <h1 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: "1.75rem", color: "#0A0A0A", marginBottom: "0.25rem" }}>Other Charges</h1>
        <p style={{ color: "#888", fontSize: "0.875rem" }}>Configure shipping, GST, and additional charges applied to all orders.</p>
      </div>
      ...
      <form onSubmit={handleSave} style={{ backgroundColor: "#fff", border: "1px solid #F0F0F0", borderRadius: "12px", padding: "1.75rem", display: "flex", flexDirection: "column", gap: "1.5rem", boxShadow: "0 2px 8px rgba(0,0,0,0.04)" }}>
        <div>
          ...
          <p style={{ color: "#888", fontSize: "0.75rem", marginTop: "0.25rem" }}>Applied as a flat shipping fee to every order.</p>
        </div>
        ...
        <div>
          ...
          <p style={{ color: "#888", fontSize: "0.75rem", marginTop: "0.25rem" }}>Enter as percentage (e.g. 3 for 3%). Applied on order subtotal.</p>
        </div>

        <div style={{ borderTop: "1px solid #F0F0F0", paddingTop: "1.25rem" }}>
          <h3 style={{ color: "#C9A84C", fontSize: "0.72rem", letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: "1rem", fontWeight: 700 }}>Additional Charges (Optional)</h3>
        ...
        {/* Preview */}
        <div style={{ backgroundColor: "#FAFAFA", borderRadius: "8px", padding: "1rem", border: "1px solid #F0F0F0" }}>
          <p style={{ color: "#888", fontSize: "0.72rem", textTransform: "uppercase", letterSpacing: "0.1em", marginBottom: "0.75rem", fontWeight: 700 }}>Preview (on ₹10,000 order)</p>
          {[
            ...
            <div key={label} style={{ display: "flex", justifyContent: "space-between", color: "#555", fontSize: "0.8rem", padding: "0.25rem 0" }}>
              <span>{label}</span><span>{value}</span>
            </div>
          ))}
          <div style={{ display: "flex", justifyContent: "space-between", color: "#0A0A0A", fontWeight: 700, fontSize: "0.9rem", borderTop: "1px solid #F0F0F0", paddingTop: "0.5rem", marginTop: "0.25rem" }}>
            <span>Total</span>
