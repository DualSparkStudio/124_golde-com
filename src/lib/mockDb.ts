...
const SEED_PRODUCTS: MockProduct[] = [
  ...
  { id: "prod-8", name: "925 Silver Anklet Pair", slug: "925-silver-anklet-pair", category: "silver", typeId: "type-8", weight: 15.0, purity: "925", quantity: 10, images: makeImg("prod-8", IMG_ANKLET), videoUrl: null, description: "Delicate silver anklets with tiny bells. Traditional payal design for daily wear.", purchasePrice: 3800, salePrice: 5500, discountPrice: 5000, makingCharges: 600, occasion: ["daily-wear", "festival"], isFeatured: false, status: "active", createdAt: new Date(Date.now() - 4 * 86400000).toISOString(), updatedAt: new Date().toISOString() },
